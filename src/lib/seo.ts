...
export const site = {
  ...
  defaultDescription:
    'Únete a NOVALUX: las mejores comisiones del sector en luz, gas, fibra y móvil. ' +
    'Tramitación rápida para autónomos y pymes que quieren una nueva línea de ingresos.',
  defaultKeywords:
    'NOVALUX, colaborador energía, comisiones luz y gas, distribuidor telecomunicaciones, ' +
    'red comercial energía, autónomos comisiones, fibra móvil comisiones',
  locale: 'es_ES',
  ogImage: '/logo.png',
